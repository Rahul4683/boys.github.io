                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="product.php"><i class="fa fa-angle-right mr-2"></i>Our Shop</a>
                            <a class="text-secondary mb-2" href="product.php"><i class="fa fa-angle-right mr-2"></i>Shop Detail</a>
                            ...
                            if (isset($_SESSION['email'])) {
                             ?>
                            <a class="text-secondary" href="review.php"><i class="fa fa-angle-right mr-2"></i>Review & Rate</a>
                            <?php
                          } 
                    ?>
                        </div>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <p>Sometimes It’s Hard Being Superior To Every Single Other Person On The Planet.</p>
                        <form action="">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    ...
                    by
                    <a class="text-primary" href="index.php">R & R</a>
                </p>
            </div>
